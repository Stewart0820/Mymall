package com.stewart.mall.stewart.controller.common;

import cn.hutool.json.JSONObject;
import com.stewart.mall.stewart.common.CommonResult;
import com.stewart.mall.stewart.utils.TencentCOSUtils;
...
public class CosController {
    ...
    private final String imagesPath = "https://smart-1251531734.cos.ap-guangzhou.myqcloud.com/";
    /**
     * 把文件上传到腾讯云存储服务器
     * @param multfile
     * @return
    ...
    public CommonResult upload(@RequestParam("file") MultipartFile multfile)throws Exception{
        ...
        if(realName=="images/"){
            ...
            String realPath = imagesPath+realName;
